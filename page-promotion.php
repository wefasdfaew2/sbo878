   ...
   <div class="content">
     <div  style="margin-top:0px;">
       ...
       <div style="background-color:#f0f0f0;border-radius:10px;">
         ...
         <div style="padding:16px;">
           <p style="text-indent: 3em;font-size:120%">
             &nbsp;รับโบนัสเครดิตเพิ่มทันที 200% รวมยอดฝากเงิน (โบนัสสูงสุดไม่เกิน 3,000) แต่ต้องมีค่า Turnover 8 เท่า ของยอดฝากขึ้นไป
             ถึงจะสามารถถอนได้ ไม่เช่นนั้นจะถูกตัดโบนัสออกตอนถอนเงิน เช่น ถ้าเติม 1,500 บาท จะมียอดเครดิต 3,000 บาท จะต้องมียอดเทิร์น
             โอเวอร์ที่ 24,000 บาท ถึงจะถอนได้โดยไม่โดนตัดโบนัสออก
   	         <p style="text-indent: 5em;font-size:120%">** ตัวอย่าง สมัครสมาชิกใหม่ 3,000 บาท รับเครดิตไปเลย 4,500 บาท **</p>
       ...
       <div style="background-color:#f0f0f0;border-radius:10px;margin-top:10px;">
         ...
         <div style="padding:16px;">
           <p style="text-indent: 3em;font-size:120%">
             &nbsp;รับโบนัสเครดิตเพิ่มทันที 10% ของยอดฝากเงิน เมื่อฝากเงินตั้งแต่ 5,000 บาทขึ้นไป (ค่า Turnover 3 เท่าของยอดฝากขึ้นไป
             ถึงจะสามารถถอนได้ ไม่เช่นนั้นจะถูกตัดโบนัสออกตอนถอนเงิน)
              <p style="text-indent: 5em;font-size:120%">
                ** ตัวอย่าง ฝากเงินเข้ามา 7,000 บาท รับเครดิตไปเลย 7,700 บาท **
              </p>
            </p>
         </div>
       </div>
       ...
       <div style="background-color:#f0f0f0;border-radius:10px;margin-top:10px;">
         ...
         <div style="padding:16px;">
           <p style="text-indent: 3em;font-size:120%">
             &nbsp;ทุกวันหวยออก ลุ้นเลขท้ายสมาชิก 2 ตัวท่านใดตรงกับเลขท้ายสลากกินแบ่งรัฐบาล รับเครติดฟรีทันที 500 บาท
            </p>
         </div>
       </div>
       <!--<div style="background-color:#f0f0f0;border-radius:10px;margin-top:10px;">
       ...
       <div style="background-color:#f0f0f0;border-radius:10px;margin-top:10px;margin-bottom:50px;">
         ...
         <div style="padding:16px;">
           ...
           <br>
           <p style="text-indent: 5em;font-size:120%">*** ลำดับขั้นสำหรับรางวัลการคืนยอดเสีย ***</p>
           <p style="text-indent: 5em;font-size:120%">อันดับ 1 ลด 10% ของยอดเสียยอดเสียสะสมสูงสุด</p>
           <p style="text-indent: 5em;font-size:120%">อันดับ 2 ลด 7% ของยอดเสียยอดเสียสะสมสูงสุด</p>
           <p style="text-indent: 5em;font-size:120%">อันดับ 3 ลด 5% ของยอดเสียยอดเสียสะสมสูงสุด</p>
           <p style="text-indent: 5em;font-size:120%">อันดับ 4 ลด 3% ของยอดเสียยอดเสียสะสมสูงสุด</p>
           <p style="text-indent: 5em;font-size:120%">อันดับ 5 ลด 1% ของยอดเสียยอดเสียสะสมสูงสุด</p>
         </div>
       </div>
     </div>
