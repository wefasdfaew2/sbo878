...
/**if (!empty($_POST['id']) && !empty($_POST['server']) && !empty($_POST['bitrate']) && !empty($_POST['mode'])) {
...
<div layout="row" style="padding-top:16px;padding-left:16px;padding-right:16px;">
...
<div layout="row" class="md-padding" layout-align="end center" style="margin-top:10px;">
	<div layout="row" layout-align="end center">
