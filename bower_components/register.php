...
<div id="page" class="single">
 ...
 $conn = new mysqli($servername, $username, $password, $dbname);
  ...
  $sql = "SELECT new_register_enable FROM global_setting";
  ...
  $conn->close();
	...
	$user_ip = "'".getRealIpAddr()."'";
     ...
     if($data[0]['new_register_enable'] == 'Yes'){
...
echo '<div class="alert alert-danger">
   ...
   echo '<div style="text-align: center;margin:25px 0 0 0;color:red;">เรียนสมาชิกทุกท่านโปรดทราบ .... ขณะนี้อยู่ในระหว่างดำเนินการทดสอบระบบใหม่ของทาง เว็บไซต์ SBOBET878.COM สำหรับท่านสมาชิกใหม่ที่ต้องการสมัครสมาชิก จะยังไม่สามารถสมัครได้จนกว่าประกาศนี้จะหายไป
     สำหรับท่านสมาชิกเดิม ยังคงสามารถใช้งานระบบต่างๆได้ตามปกติค่ะ</div><br>';
   echo '<div style="text-align: center;margin-bottom:25px;">ขออภัยขณะนี้เรายังไม่เปิดให้สมัครสมาชิกใหม่ แต่ท่านสามารถเยี่ยมชมเว็บไซต์ของเราและดูบอลสดได้ตามปกติ กรุณาติดต่อ Call Center สำหรับรายละเอียดเพิ่มเติม หรือ กลับมาสมัครใหม่ในภายหลัง</div>';
 }
 }else{
