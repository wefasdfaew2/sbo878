	...
	<footer id="contact" class="site-footer template-wrap" role="contentinfo">
		...
		<div class="site-info">
			...
			<div class="copyright">
				...
				<br>
				<!--Also check out: <a href="https://www.enginethemes.com/themes/microjobengine" target="_blank">WordPress Micro Jobs Theme</a>. Designed by <a href="http://www.enginethemes.com"  target="_blank">EngineThemes</a>.-->
			</div>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
	<?php } ?>
