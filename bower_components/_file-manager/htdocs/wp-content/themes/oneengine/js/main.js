...
//$( '#portfolio_filter a' ).on( "click", gotoPortFo);
...
jQuery(document).ready(function($) {
	...
	$('#portfolio_filter a').click(function(){
		...
		//scrollTop($('#portfolio_list'), 1000);
		//scrollTop: $("#portfolio_list").offset().top}, 2000);
	...
	function random(owlSelector){
	  owlSelector.children().sort(function(){
		  return 0;//Math.round(Math.random()) - 0.5;
	  }).each(function(){
		$(this).appendTo(owlSelector);
	  });
	}
	function beforeInit(owlSelector){
...
$( "#portfolio_filter a" ).on( "click", function() {
			...
			$.scrollTo("#sad", 800);
			return false;
			 //$.scrollTo($("#portfolio_list"), { duration: 1000});
			//$('html, body').animate({
			//	scrollTop: $("#portfolio_list").offset().top
			//}, 2000);
		});	**/
